...
import { Age, Classe, Commune, Comportement, Departement, EntiteSimple, Espece, EstimationDistance, EstimationNombre, Lieudit, Meteo, Milieu, Observateur, PostResponse, Sexe } from "@ou-ca/ouca-model";
