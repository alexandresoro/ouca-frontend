...
import { PreviousAndNextDonnees } from "./../../model/previous-and-next-donnees.object";
...
export class CreationService extends BaseNaturalisteService {
    ...
    public getInitialPageModel(): Observable<CreationPage> {
        return this.http.get(this.BASE_NATURALISTE_URL + this.ENTITY_NAME + "/init")
    ...
    public deleteDonnee(id: number): Observable<EntiteResult<Donnee>> {
        return this.http.delete(this.BASE_NATURALISTE_URL + this.ENTITY_NAME + "/donnee/delete/" + id)
            .map(this.extractDeleteResponse)
            .catch(this.handleError);
    }

    public getNextRegroupement(): Observable<number> {
        return this.http.get(this.BASE_NATURALISTE_URL + this.ENTITY_NAME + "/next_regroupement")
            .map(this.extractModel)
            .catch(this.handleError);
    }
    ...
    private extractModel(res: Response): CreationPage {
        return res.json();
    }
